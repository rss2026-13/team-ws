...
bool custom_msgs__msg__open_space__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._open_space.OpenSpace", full_classname_dest, 37) == 0);
  }
  custom_msgs__msg__OpenSpace * ros_message = _ros_message;
  {  // angle
...
{
  /* NOTE(esteve): Call constructor of OpenSpace */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._open_space");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OpenSpace");
