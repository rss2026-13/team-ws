...
static const _ConeLocationPixel_type_support_symbol_names_t _ConeLocationPixel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vs_msgs, msg, ConeLocationPixel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vs_msgs, msg, ConeLocationPixel)),
  }
};
...
{
  return &::vs_msgs::msg::rosidl_typesupport_cpp::ConeLocationPixel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vs_msgs, msg, ConeLocationPixel)() {
  return get_message_type_support_handle<vs_msgs::msg::ConeLocationPixel>();
}
