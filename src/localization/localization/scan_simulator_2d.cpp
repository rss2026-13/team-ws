 ...
 */
    ...
    __pyx_t_12.y = (*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_poses.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_poses.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_poses.diminfo[1].strides));
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_14 = 2;
    __pyx_t_6 = -1;
    if (__pyx_t_13 < 0) {
 ...
 */
    ...
    __pyx_t_6 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_pybuffernd_scans.diminfo[0].shape;
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_scans.diminfo[0].shape)) __pyx_t_6 = 0;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_pybuffernd_scans.diminfo[1].shape;
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_6 = 1;
    } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_scans.diminfo[1].shape)) __pyx_t_6 = 1;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 91, __pyx_L1_error)
    }
    __pyx_v_self->thisptr->scan(__pyx_v_p, (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_scans.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_scans.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_scans.diminfo[1].strides))));
  }
